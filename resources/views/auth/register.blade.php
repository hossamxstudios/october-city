                                ...
                                <div class="mb-4 auth-brand">
                                    <a href="{{ route('login') }}" class="logo-dark">
                                        <span class="gap-1 d-flex align-items-center">
                                            ...
                                            <span class="logo-text text-body fw-bold fs-xl">October Archive System</span>
                                        </span>
                                    </a>
                                    <a href="{{ route('login') }}" class="logo-light">
                                        <span class="gap-1 d-flex align-items-center">
                                            ...
                                            <span class="text-white logo-text fw-bold fs-xl">October Archive System</span>
                                        </span>
                                    </a>
                                    <p class="mt-3 text-muted w-lg-75">Create your October Archive System account to manage access and enjoy the
